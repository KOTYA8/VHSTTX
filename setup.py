...
setup(
    ...
    package_data={
        ...
        'teletext.gui': [
            'decoder.qml',
            'editor.ui',
            'launcher_fields.json',
            'launcher_fields_default.json',
            'launcher_field_presets.json',
            'teletext.png',
            'tteditor.png',
            'vhsttxgui.png',
            'teletext.css',
    ...
    entry_points={
        'console_scripts': [
            ...
            'tteditor-install = teletext.gui.editor_install:main',
            'tteditor-uninstall = teletext.gui.editor_install:uninstall_main',
